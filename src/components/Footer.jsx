...
export default function Footer() {
  return (
    <div className='py-5 dark:bg-slate-800 bg-cyan-500 text-center text-gray-300'>
        ...
        <a href="https://github.com/RafaeltiMoreira"
            className='text-lg md:text-md dark:text-gray-400 text-white' target='_blank' title='GitHub'
        ><VscGithubInverted className='inline-block mb-1' /> RafaeltiMoreira</a>

        <p className='text-lg mt-2 dark:text-gray-400 text-white'>&copy; Desenvolvido por Rafael Moreira &middot; {new Date().getFullYear()} &middot; Todos os direitos reservados.</p>
    </div>
  )
}